...
class _SignInDesktopState extends State<SignInDesktop> {
  ...
  Widget build(BuildContext context) {
    print(
        'Current view: ${_showForgotPass ? "Forgot Password" : _showChangePassword ? "Change Password" : _showReEnrollView ? "ReEnroll" : "Sign In"}');
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(
                      horizontal: cardWidth *
                          0.075, // Reduced from 0.1 to 0.075 for better scaling
                    ),
                    child: Container(
                      width: inputWidth,
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: cardWidth *
                              0.045, // Slightly reduced for better proportion
