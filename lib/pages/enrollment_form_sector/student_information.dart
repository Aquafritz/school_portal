...
class StudentInformationState extends State<StudentInformation>
  ...
  final FocusNode _householdIdFocusNode = FocusNode();
  final FocusNode _motherTongueFocusNode = FocusNode();
  ...
  Future<void> _uploadImage() async {
    ...
    final imageRef = storageRef
        .child('student_pictures/${DateTime.now().toIso8601String()}.png');
  ...
  Future<bool> checkIfEmailExists() async {
    ...
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        ...
        .where('email_Address',
            isEqualTo: email) // Query based on the email field value
        .get();
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border:
                              Border.all(color: Color(0xFF03b97c), width: 1.0),
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.all(Radius.circular(8.0)),
                          borderSide:
                              BorderSide(color: Color(0xFF03b97c), width: 1.0),
                        ),
                ...
                decoration: InputDecoration(
                  ...
                  label: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        if (_psaFocusNode.hasFocus ||
                            _psaController.text.isNotEmpty)
                          TextSpan(
                      ...
                      children: [
                        if (_middleNameFocusNode.hasFocus ||
                          ...
                          TextSpan(
                            text: '(optional)',
                            style: TextStyle(
                              color: Color.fromARGB(255, 101, 100,
                                  100), // Red color for the asterisk
                            ),
                          ),
                      ],
                    ),
                ...
                decoration: InputDecoration(
                  ...
                  label: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        if (_extensionNameFocusNode.hasFocus ||
                            _extensionNameController.text.isNotEmpty)
                          TextSpan(
                            text: '(optional)',
                            style: TextStyle(
                              color: Color.fromARGB(255, 101, 100, 100),
              ...
              child: TextFormField(
                ...
                onTap: () async {
                  ...
                  FocusScope.of(context).requestFocus(
                      FocusNode()); // Prevents keyboard from showing up
                  DateTime? selectedDate = await showDatePicker(
                    context: context,
                    initialDate: DateTime.now(),
                    firstDate: DateTime(1900),
                ...
                decoration: InputDecoration(
                  ...
                  label: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        if (_religionFocusNode.hasFocus ||
                ...
                decoration: InputDecoration(
                  ...
                  label: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        if (_motherTongueFocusNode.hasFocus ||
                            _motherTongueController.text.isNotEmpty)
                          TextSpan(
                            text: '*',
                            style: TextStyle(
                              color: Colors.red,
